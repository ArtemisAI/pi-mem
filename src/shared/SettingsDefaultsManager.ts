...
export interface SettingsDefaults {
  ...
  CLAUDE_MEM_OPENROUTER_BASE_URL: string;  // OpenAI-compatible endpoint URL (for self-hosted models)
...
export class SettingsDefaultsManager {
  ...
  private static readonly DEFAULTS: SettingsDefaults = {
    ...
    CLAUDE_MEM_OPENROUTER_BASE_URL: 'https://openrouter.ai/api/v1/chat/completions',  // Override for local/compatible servers
    ...
    CLAUDE_MEM_OPENROUTER_FALLBACK_URL: '',          // Empty = no fallback (observations lost on failure)
    CLAUDE_MEM_OPENROUTER_FALLBACK_KEY: '',           // API key for fallback (can differ from primary)
    CLAUDE_MEM_OPENROUTER_FALLBACK_MODEL: '',         // Model for fallback (empty = use primary model)
    // System Configuration
