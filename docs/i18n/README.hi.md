...
[pi-agents](https://github.com/badlogic/pi-mono) के लिए claude-mem को एक स्थायी मेमोरी एक्सटेंशन के रूप में इंस्टॉल करें:

```bash
pi install npm:pi-agent-memory
```

किसी भी pi-mono-आधारित एजेंट (pi-coding-agent, OpenClaw, कस्टम रनटाइम) को क्रॉस-सेशन मेमोरी प्रदान करता है। अवलोकन उसी डेटाबेस में सभी इंजन के बीच साझा किए जाते हैं। पूरी जानकारी के लिए [pi-agent README](../pi-agent/README.md) देखें।
