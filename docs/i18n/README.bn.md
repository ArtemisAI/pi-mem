...
[pi-agents](https://github.com/badlogic/pi-mono)-এর জন্য claude-mem একটি স্থায়ী মেমরি এক্সটেনশন হিসেবে ইনস্টল করুন:

```bash
pi install npm:pi-agent-memory
```

যেকোনো pi-mono-ভিত্তিক এজেন্টকে (pi-coding-agent, OpenClaw, কাস্টম রানটাইম) ক্রস-সেশন মেমরি প্রদান করে। একই ডেটাবেসে সকল ইঞ্জিনের মধ্যে পর্যবেক্ষণ ভাগ করা হয়। সম্পূর্ণ বিবরণের জন্য [pi-agent README](../pi-agent/README.md) দেখুন।
